...
The next experiment we want to evaluate is similar to the previous nine dimensional problem. This time, we only use 2 hyperparameters as the authors did in \cite{WU201926}. They optimized the batch size and the learning rate of the optimizer. The first one is an integer interval between 20 and 2000 and the learning rate is between 0 and 1. 
...
\begin{itemize}
	\item Precise explanation of the algorithm
	\item Different refinement strategies
	\item Different criteria
	\item Implementation
\end{itemize}
