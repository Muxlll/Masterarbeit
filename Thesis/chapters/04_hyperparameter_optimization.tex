...
Experiments:
\begin{itemize}
	\item 2d (epochs, learning rate) with small network, multiple datasets, comparison of methods 
	\item 3d (epochs, learning rate, batch size) with small network, multiple datasets, comparison of methods 
	\item 5d (epochs, learning rate, batch size, number of layers, neurons per layer), multiple datasets, comparison of methods 
\end{itemize}
