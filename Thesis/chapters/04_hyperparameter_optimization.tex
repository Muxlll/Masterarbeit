...
\begin{figure}[htbp!]
	\centering
	\includegraphics[width=0.31\textwidth]{figures/Results/Machine_learning/optimizer/Optimizers_visualization_ml_5}
	\includegraphics[width=0.31\textwidth]{figures/Results/Machine_learning/optimizer/Optimizers_visualization_ml_10}
	\includegraphics[width=0.31\textwidth]{figures/Results/Machine_learning/optimizer/Optimizers_visualization_ml_30}
	
	\caption{  }
	\label{fig:optimizers_network_visualization}
\end{figure}

In Figure \ref{fig:optimizers_network_visualization}, the solution of the gradient descent optimization algorithm is analyzed with 5, 9, and 29 grid points on the left, center, and right, respectively. The minimal interpolated function values and the actual function evaluations can be seen in Table \ref{tab:results_opt_ml}.
...
In the first case, the optimizer starts at the right grid points and makes one step towards the right boundary of the domain. In the center, the solution of the optimizer is at the right top corner of the domain. 
