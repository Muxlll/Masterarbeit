...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot coordinates
			{(15,0.17085522338747977)(20,0.15570929311215878)(30,0.12546524107456208)(40,0.09796145539730787)(50,0.11236386708915233)(60,0.11014161929488182)(70,0.08918306156992913)(80,0.08909676894545555)(90,0.08251675572246313)(100,0.09207458049058914)}
			;
			
			\addplot coordinates 
			{(15,0.2135143307968974)(20,0.17106599342077972)(30,0.20546316485852004)(40,0.11698700953274965)(50,0.13199663180857896)(60,0.09910747352987528)(70,0.1283601655624807)(80,0.1145835742354393)(90,0.11219834145158529)(100,0.1126535750925541)}
			;
			
			\addplot coordinates
			{(15,0.15346778202801942)(20,0.12807831205427647)(30,0.13472946528345348)(40,0.12490067407488822)(50,0.11091633513569832)(60,0.13224060665816068)(70,0.13538499288260936)(80,0.1170282680541277)(90,0.10562000963836908)(100,0.10916520934551954)}
			;
...
\begin{outline}
	\1 Discussion of Sparse grids optimization
		\2 Problem of Sparse grids
			...
			\3 Sparse grid optimization with additional optimization algorithm on top: in hyperparameter opt not really enough points to create well enough interpolant
				\4 However still use it, sometimes finds better configuration 
				\4 only 2 more function evaluations
		\2 referring to top points: not really important because of application of hyperparameter optimization:
			\3 solution has to be found fast $\rightarrow$ expensive function evaluation
			\3 exact optimum not necessary to be found, only a very good value 
			\3 often even multiple good configurations 
			\3 stochastic behavior $\rightarrow$ cannot even guarantee that exact optimum is the same in all different evaluations
	\1 Discussion iterative adaptive random search
		...
		\2 experiments show that it is promising
	\1 Comparison
