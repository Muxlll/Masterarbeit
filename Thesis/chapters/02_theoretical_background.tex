	...
	\begin{tikzpicture}[]
		\begin{axis}[view = {50}{30},
			...
			%\addplot3[] coordinates {
				%	(0.5,0,0) (0.5,0.25,1) (0.5,0.5,0) (0.5,1,0)};
			
			\addplot3[] coordinates {
				(1,0,0) (1,0.25,1) (1,0.5,0) (1,1,0)};
			
			%\addplot3[] coordinates {
				%	(0.0,0.25,0) (0.5,0.25,1) (1,0.25,0)};
			
			\addplot3[] coordinates {
				(0.0,1,0) (0.5,1,1) (1,1,0)};
			
			\addplot3[surf] file {figures/data.dat};
			
		\end{axis}
		\end{tikzpicture}
	\caption{ Example of a basis function in two dimensions. It is constructed with the tensor product of two 1d hat functions. Inspired from \cite{garcke2013sparse}. }
	\label{fig:2d_basis}
\end{figure}
