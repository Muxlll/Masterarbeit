...
\begin{figure}[htbp!]
	...
	\caption{ Neural network consisting of only one perceptron. }
...
\end{equation}
with $ \left|\vec{l}\right| = \max_{1 \le i \le d} |d_i| $. Again, a function can be interpolated by its interpolant $ u $ with
\begin{equation}
