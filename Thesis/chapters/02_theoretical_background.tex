...
\subsection{Adaptive Random Search}\label{Adaptive_random_search}


\cite{hamzaccebi2006heuristic}: ARSET (adaptive random search) \newline 

\cite{MASRI1980353}: adaptive step size search, local optimization with additional wide range search -> also global optimum \newline 

\cite{random_search_2}: 3 different approaches, but with high number of function evaluations needed \newline 
